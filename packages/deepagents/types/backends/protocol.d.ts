 ...
 */
export declare function isSandboxBackend(backend: unknown): backend is SandboxBackendProtocolV2;
/**
 ...
 */
export declare function isSandboxProtocol(backend: unknown): backend is AnySandboxProtocol;
/**
 ...
 * @internal
 */
export declare function resolveBackend(
