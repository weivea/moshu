...
const en = {
	...
	"conn.offline.body": "Moshu needs a network connection to reach your Agent Server. Reconnecting automatically.",
	...
	"onboarding.body": "Moshu on iPhone pairs with one Agent Server running on your Desktop. Your Desktop must be online with Remote Access enabled.",
	...
	"error.identityMismatch.body": "The Agent Server identity does not match the one you paired with. For your safety, connection was blocked. Unpair and pair again only if you trust this server.",
	"error.urlInvalid.title": "Can't reach the Agent Server",
	"error.urlInvalid.body": "The stored connection address is invalid. Unpair and scan a fresh QR code.",
	...
	"settings.securityNote": "Your device key is stored in the iOS Keychain and never leaves this iPhone. Business data is never cached; it lives only while connected.",
	...
	"settings.runtimeBoxNote": "Choose which Runtime Box this device talks to. This selection is specific to this device.",
	...
	"settings.unpair.body": "This deletes the device key and connection binding from this iPhone. You'll need to scan a new QR code to reconnect.",
...
const zh: Record<MessageKey, string> = {
	...
	"onboarding.body": "iPhone 上的墨枢会与桌面端运行的一个 Agent Server 配对。桌面端必须在线并已启用远程访问。",
	...
	"error.identityMismatch.body": "Agent Server 身份与配对时不一致。出于安全考虑已阻止连接。仅在你信任该服务器时才解绑并重新配对。",
	...
	"settings.securityNote": "你的设备密钥保存在 iOS 钥匙串中，绝不会离开这台 iPhone。业务数据从不缓存，仅在连接期间存在。",
	...
	"settings.unpair.body": "这将从此 iPhone 删除设备密钥和连接绑定。你需要扫描新的二维码才能重新连接。",
